...
class Application: WebSocketSessionHandler {
    ...
    let socketProtocol: String? = "paper.freshmint.it" //in future not fixed
    
    // This function is called by the WebSocketHandler once the connection has been established.
    // overrided for perform user defined algoritm
    func handleSession(request: HTTPRequest, socket: WebSocket) {
        ...
        //print(request.header(.userAgent))
